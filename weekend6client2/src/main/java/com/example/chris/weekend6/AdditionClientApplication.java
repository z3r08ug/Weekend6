...
public class AdditionClientApplication extends Application
{
    ...
    public static AdditionClientApplication get(Context context)
    {
        return (AdditionClientApplication) context.getApplicationContext();
    }
